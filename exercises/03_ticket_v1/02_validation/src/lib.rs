...
impl Ticket {
    ...
    fn new(title: String, description: String, status: String) -> Self {
        ...
        // println!("{:?}", title.bytes().gt(*ff));
        //panic!("{:?}", title.as_bytes().len());
        ...
        //     !status.eq("To-Do") || !status.eq("Done") || !status.eq("In Progress")
        // );

        if !status.eq("To-Do") && !status.eq("Done") && !status.eq("In Progress") {
